      ...
      this.innerHTML = `
        ...
        <main class="bw-gsl" data-headline-variant="${this._variant()}">
          ...
          <section class="bw-gsl-route" id="bw-google-route">
            ...
            <p>I start at Alexanderplatz, cross Berlin's historic centre and finish at Hackescher Markt. You see the places first, then I connect the history around them.</p>
