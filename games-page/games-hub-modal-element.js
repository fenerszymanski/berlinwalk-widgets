(function () {
  ...
  const GAMES = [
    ...
    },
    {
      ...
      short: 'Would you get in?',
      lane: 'Dress code test',
      ...
      start: 'Immediate',
      bestFor: 'Nightlife curiosity, outfit doubt, dress code questions',
      score: 'Door result',
      lead: 'Nine honest questions about outfit, effort and attitude decide a fictional KitKat door verdict.',
      rules: [
        'Pick tonight\'s party first.',
        'Answer nine outfit and attitude questions.',
        'Accept the door verdict.'
      ],
      tourBridge: 'Strongest when a Berlin nightlife or dress-code article needs a playful challenge link.',
      cta: 'Take the test'
    },
    {
