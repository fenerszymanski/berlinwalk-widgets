(function () {
  ...
  const ASSET_VERSION = 'games-page-kitkat-photo-cover-20260826';
  const GAMES = [
    {
    ...
    },
    {
      ...
      lead: 'A quick Berghain simulator with outfits, answers and one very Berlin kind of judgement.',
      how: 'Choose fast, stay calm, and see if the fictional door lets you into the night.',
      duration: 'Under 1 min',
    ...
    {
      id: 'kitkat-door-test',
      kicker: 'Dress code test',
      title: 'KitKat Club Door Test',
      lead: 'Nine honest questions about your outfit, effort and attitude, then a fictional KitKat door verdict.',
      how: 'Pick tonight\'s party, answer nine quick questions, and see if the fictional door lets you in.',
      duration: 'Under 1 min',
      difficulty: 'Door test',
      player: 'Outfit courage',
      image: 'kitkat-door-test/assets/social/kitkat-door-test-social-1200x630.jpg',
      href: 'https://www.berlinwalk.com/games/kitkat-door-test',
  ...
  class BWGamesPageElement extends HTMLElement {
    ...
    _styles() {
      return `
        ...
        .bw-game-card-kitkat .bw-game-kicker {
          color: #E4002B;
        }
