...
- The actual Wix call may create/update only the new page's Custom Embed and must leave the site unpublished.
- Commit only the intended package and new updater/verifier paths. Pin the jsDelivr URL to that exact commit.
