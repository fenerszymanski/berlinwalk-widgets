...
5. **Publish the blog redesign v1.** Push `berlinwalk-widgets`, wait for GitHub Pages, then replace the Wix `/blog` feed area with `<bw-blog-index>` and add `js/blog-journey-inject.js?v=4` as a blog/post Custom Code helper.
