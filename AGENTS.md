...
5. **Publish the blog redesign v1.** Push `berlinwalk-widgets`, wait for GitHub Pages, then use `blog-index/blog-index-element.js?v=2` for `<bw-blog-index>` and add `js/blog-journey-inject.js?v=5` as a blog/post Custom Code helper.
