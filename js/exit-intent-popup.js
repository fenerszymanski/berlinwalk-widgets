...
(function () {
  ...
  function isCheckoutPage() {
    return window.location.pathname.indexOf('/book-berlin-walking-tour') === 0;
  }
  ...
  function shouldRun() {
    return isDesktop() && !isCheckoutPage() && !safeSessionGet(SESSION_KEY);
  }
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.bw-exit-card{position:relative;width:min(520px,100%);border-radius:8px;border:1px solid rgba(255,230,0,.24);background:rgba(27,94,32,.96);box-shadow:0 30px 80px rgba(0,0,0,.42);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);overflow:hidden;transform:translateY(14px) scale(.98);transition:transform .22s ease;}',
      ...
      '.bw-exit-inner{position:relative;padding:42px 38px 36px;text-align:left;}',
      ...
      '.bw-exit-title{margin:0 44px 14px 0;color:#FFFFFF;font-size:34px;line-height:1.05;font-weight:900;letter-spacing:0;}',
      '.bw-exit-copy{margin:0 0 28px;color:#FAFAF5;font-size:15px;line-height:1.6;font-weight:500;max-width:43em;}',
  ...
  function renderPopup() {
    ...
    overlay.innerHTML = [
      ...
      '<p class="bw-exit-copy">Before you go, lock in a free spot on BerlinWalk: a tip-based, English walking tour from Alexanderplatz through the city stories most visitors miss.</p>',
      ...
      '<p class="bw-exit-copy">Get the quick Berlin sheet: transport basics, Sunday rules, cash tips, safety notes, and the small things that make a first visit easier.</p>',
