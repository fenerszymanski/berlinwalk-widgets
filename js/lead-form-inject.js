...
(function () {
  ...
  function ensureDateCheckStyles() {
    ...
    style.textContent = [
      ...
      '@media(min-width:701px){.bw-date-check-blog-card__date-display{display:none}.bw-date-check-blog-card__date-control input{position:relative!important;inset:auto!important;padding:0 14px!important;background:#fff!important;color:#212121!important;-webkit-text-fill-color:#212121!important;opacity:1!important;cursor:text;color-scheme:light}}',
  ...
  function buildDateCheckCard(slug) {
    ...
    arrivalInput.addEventListener('click', function () {
      if ((window.innerWidth || 0) >= 701) return;
