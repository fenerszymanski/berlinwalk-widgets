...
(function () {
  ...
  function ensureDateCheckStyles() {
    ...
    style.textContent = [
      ...
      '.bw-date-check-blog-card__scrim{position:absolute;inset:0;display:flex;flex-direction:column;justify-content:flex-end;padding:26px;background:linear-gradient(180deg,rgba(8,45,22,.10) 18%,rgba(8,45,22,.92) 100%);color:#fff}.bw-date-check-blog-card__eyebrow{margin:0 0 10px;font-family:"IBM Plex Mono",monospace;font-size:11px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--bw-yellow)}',
      '.bw-date-check-blog-card h2{margin:0;font-family:Fraunces,Georgia,serif;font-size:clamp(29px,4vw,40px);line-height:1.02;letter-spacing:-.02em;color:#fff}.bw-date-check-blog-card__copy{margin:12px 0 0;font-size:15px;line-height:1.48;color:rgba(255,255,255,.94)}.bw-date-check-blog-card__proof{display:flex;flex-wrap:wrap;gap:6px;margin-top:17px}.bw-date-check-blog-card__proof span{padding:5px 7px;border:1px solid rgba(255,255,255,.52);font-family:"IBM Plex Mono",monospace;font-size:9px;letter-spacing:.06em;text-transform:uppercase;color:#fff}',
      '.bw-date-check-blog-card__form{display:flex;flex-direction:column;justify-content:center;gap:17px;padding:30px}.bw-date-check-blog-card__fields{display:grid;grid-template-columns:minmax(0,1fr) minmax(112px,.42fr);gap:12px}.bw-date-check-blog-card__field{display:flex;flex-direction:column;gap:7px}.bw-date-check-blog-card__field label{font-family:"IBM Plex Mono",monospace;font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--bw-green-ink)}',
      '.bw-date-check-blog-card__field input,.bw-date-check-blog-card__field select{width:100%;min-height:54px;padding:0 14px;border:1.5px solid var(--bw-green-ink);border-radius:8px;background:#fff;color:#212121;font:600 15px/1 Montserrat,Arial,sans-serif}.bw-date-check-blog-card__field input:focus,.bw-date-check-blog-card__field select:focus{outline:3px solid rgba(255,230,0,.68);outline-offset:2px}',
      ...
      '.bw-date-check-blog-card__micro{margin:0;font-size:12.5px;line-height:1.45;color:#58705C}.bw-date-check-blog-card__status{min-height:18px;margin:0;color:#A2222B;font-size:12.5px;font-weight:700;line-height:1.4;overflow-wrap:anywhere}',
      ...
      '@media(max-width:430px){.bw-date-check-blog-card{margin:22px 0;border-radius:14px}.bw-date-check-blog-card__visual{min-height:245px}.bw-date-check-blog-card h2{font-size:34px}.bw-date-check-blog-card__copy{font-size:14.5px}.bw-date-check-blog-card__form{padding:20px}.bw-date-check-blog-card__fields{grid-template-columns:1fr}.bw-date-check-blog-card__field input,.bw-date-check-blog-card__field select{min-height:52px}.bw-date-check-blog-card__submit{min-height:54px;font-size:15px}}',
  ...
  function buildDateCheckCard(slug) {
    ...
    card.innerHTML = [
      ...
      '<p class="bw-date-check-blog-card__eyebrow">Berlin Date Check</p><h2 id="' + id + '-title">Check your Berlin trip dates</h2>',
      '<p class="bw-date-check-blog-card__copy">See closures, book-by dates and daylight for your exact stay.</p><div class="bw-date-check-blog-card__proof" aria-label="Date Check covers"><span>Closures</span><span>Book-by</span><span>Daylight</span></div></div></div>',
      ...
      '<p class="bw-date-check-blog-card__micro">Your result uses the dates you enter, not a generic Berlin week.</p><p class="bw-date-check-blog-card__status" role="status" aria-live="polite"></p></form>'
    ].join('');
