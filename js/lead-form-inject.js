...
(function () {
  ...
  function ensureDateCheckStyles() {
    ...
    style.textContent = [
      ...
      '.bw-date-check-blog-card__field input,.bw-date-check-blog-card__field select{display:block;inline-size:100%;width:100%;min-inline-size:0;min-width:0;max-inline-size:100%;max-width:100%;min-height:54px;padding:0 14px;border:1.5px solid var(--bw-green-ink);border-radius:8px;background:#fff;color:#212121;font:600 15px/1 Montserrat,Arial,sans-serif}.bw-date-check-blog-card__field input:focus,.bw-date-check-blog-card__field select:focus{outline:3px solid rgba(255,230,0,.68);outline-offset:2px}',
      ...
      '@media(max-width:430px){.bw-date-check-blog-card{margin:22px 0;border-radius:14px}.bw-date-check-blog-card__visual{min-height:260px}.bw-date-check-blog-card[data-bw-date-check-card] .bw-date-check-blog-card__title{font-size:34px!important}.bw-date-check-blog-card[data-bw-date-check-card] .bw-date-check-blog-card__copy{font-size:14.5px!important}.bw-date-check-blog-card__form{padding:20px}.bw-date-check-blog-card__fields{grid-template-columns:minmax(0,1fr)}.bw-date-check-blog-card__field input,.bw-date-check-blog-card__field select{min-height:52px}.bw-date-check-blog-card__submit{min-height:54px;font-size:15px}}',
