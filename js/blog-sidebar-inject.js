...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      'html body #bw-desktop-cta .bw-pill,html body #bw-desktop-cta .bw-pill-planner{width:176px!important;min-height:42px!important;padding:3px!important;}',
      'html body #bw-desktop-cta .bw-pill{margin-top:6px!important;}',
      'html body #bw-desktop-cta .bw-link,html body #bw-desktop-cta .bw-link-planner{gap:6px!important;min-height:36px!important;padding:7px 34px 7px 8px!important;}',
