...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.bw-blog-mini-nav-inner{background:#FFFFFF;border:1px solid rgba(27,94,32,.14);border-radius:8px;box-shadow:0 12px 28px rgba(27,94,32,.07);overflow:hidden;padding:0;transition:box-shadow .18s ease,opacity .18s ease,transform .18s ease;}',
      ...
      '.bw-blog-mini-nav-link{align-items:center;background:#FAFAF5;border:1px solid rgba(27,94,32,.14);border-radius:999px;color:#1B5E20;display:inline-flex;flex:0 0 auto;font-size:12px;font-weight:850;justify-content:center;line-height:1.15;min-height:34px;padding:0 11px;position:relative;text-align:center;text-decoration:none;white-space:nowrap;}',
      ...
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-content{padding:9px 12px;}',
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-inner:before{height:4px;}',
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-row{gap:10px;}',
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-home{font-size:12px;min-height:32px;padding:0 14px;}',
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-label{font-size:10px;line-height:34px;}',
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-list{gap:6px;}',
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-link{font-size:11.5px;min-height:32px;padding:0 10px;}',
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-link:after{bottom:5px;left:10px;right:10px;}',
      ...
      '@media (max-width:700px){.bw-blog-mini-nav{margin:0 0 22px;}.bw-blog-mini-nav-inner{border-radius:8px;}.bw-blog-mini-nav-content{padding:14px 12px 16px;}.bw-blog-mini-nav-row{display:block;}.bw-blog-mini-nav-home{display:flex;font-size:13px;min-height:40px;width:100%;}.bw-blog-mini-nav-group{display:block;padding-top:13px;}.bw-blog-mini-nav-label{display:block;font-size:10px;line-height:1;margin:0 0 10px;}.bw-blog-mini-nav-list{display:grid;gap:8px;grid-template-columns:repeat(2,minmax(0,1fr));}.bw-blog-mini-nav-link{display:flex;font-size:12.5px;min-height:38px;padding:0 8px;white-space:normal;}.bw-blog-mini-nav-link:after{bottom:6px;left:14px;right:14px;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-inner{border-left:0;border-radius:0;border-right:0;left:0;top:0;width:100vw;z-index:2147483000;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-content{padding:7px 8px 8px;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-row{align-items:center;display:flex;gap:8px;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-home{flex:0 0 auto;font-size:12px;min-height:34px;padding:0 12px;width:auto;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-group{display:block;flex:1 1 auto;min-width:0;padding-top:0;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-label{display:none;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-list{display:flex;flex-wrap:nowrap;gap:6px;overflow-x:auto;padding-bottom:1px;scrollbar-width:none;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-list::-webkit-scrollbar{display:none;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-link{flex:0 0 auto;font-size:11.5px;min-height:34px;padding:0 11px;white-space:nowrap;}.bw-blog-mini-nav-stuck .bw-blog-mini-nav-link:after{bottom:5px;left:11px;right:11px;}}',
