...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.bw-blog-mini-nav-stuck .bw-blog-mini-nav-inner{left:var(--bw-blog-mini-nav-left,24px);position:fixed;top:0;width:var(--bw-blog-mini-nav-width,calc(100vw - 48px));z-index:8998;}',
