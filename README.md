...
- `berlin-battle-home/` - `bw-berlin-battle-home` homepage teaser section for BerlinWalk Games, using real game art for Berlin Battle, Berghain Bouncer, and Berlin Smile Challenge with CTAs to `/games` plus booking.
...
- `js/exit-intent-popup.js` - sitewide desktop-only exit-intent popup with a booking-first CTA.
...
| Games Home | `bw-berlin-battle-home` | `https://fenerszymanski.github.io/berlinwalk-widgets/berlin-battle-home/berlin-battle-home-element.js?v=games-home-compact-20260624` | Homepage game teaser linking to `/games`, the three current games, and booking. |
...
- `js/exit-intent-popup.js` - sitewide desktop-only exit-intent popup for
  ...
  `sessionStorage`, and links its CTA to the booking route.
