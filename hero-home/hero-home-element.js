      ...
      <section class="bw-hero-home" aria-labelledby="bw-hero-home-title">
        <picture class="bw-hero-picture">
          <source
            ...
            type="image/webp"
            srcset="${BW_HERO_HOME_ASSET_BASE}hero-home-museum-island-800w.webp">
          <source
            type="image/webp"
        ...
        <div class="bw-hero-inner">
          ...
          <div class="bw-hero-bottom">
            <div class="bw-hero-route" aria-label="Tour route">
              ...
              <span class="bw-route-dot" aria-hidden="true"></span>
              <p><span class="bw-route-copy-full"><strong>Starts:</strong> World Clock, Alexanderplatz. <strong>Ends:</strong> Hackescher Markt.</span><span class="bw-route-copy-mobile"><strong>World Clock</strong> to <strong>Hackescher Markt</strong></span></p>
            </div>
