class BWHowItWorksElement extends HTMLElement {
  ...
  _render() {
    const steps = [
      { num: 1, icon: 'calendar', title: 'Reserve your place', subtitle: '€2 refundable deposit per guest', chip: '~30 SEC' },
      ...
      <section class="bw-how-it-works" role="region" aria-label="How the tour works">
        <div class="bw-how-inner">
          ...
          <div class="bw-how-cta-row">
            <a class="bw-how-cta" href="https://www.berlinwalk.com/book-berlin-walking-tour/berlin-free-walking-tour-tip-based">Reserve your place</a>
          </div>
        </div>
      </section>
    `;
