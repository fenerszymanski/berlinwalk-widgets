...
(function () {
  ...
  var RESULTS = {
    ...
    clubmate:    { emoji: '🧉', title: 'Club Mate Creature', desc: 'Caffeine, bench, repeat. You ran the day on Club Mate and stubbornness, which is a deeply Berlin way to survive.', tip: 'A Mate resets the feet, not the stomach. Pair it with real food and you are unstoppable.' },
    spati:       { emoji: '🏪', title: 'Spaeti Strategist', desc: 'You let the Spaeti run your day: cheap, open late, always there. It is not glamorous, but you never went hungry or broke.', tip: 'The Spaeti is the local safety net. Learn which corner has one and the city gets a lot easier.' },
    saint:       { emoji: '😇', title: 'Budget Saint', desc: 'You finished the day with money still in your pocket and food still in your stomach. Genuinely impressive restraint.', tip: 'You clearly do not need help saving money. Come spend the walk learning what you saved it for.' },
    fumes:       { emoji: '🌙', title: 'Late-Night Survivor', desc: 'You made it to the end, but mostly on fumes. Low battery, low snacks, still standing. Berlin respects that.', tip: 'You survived. Eat one proper meal earlier next time and the whole day feels twice as long.' },
    wanderer:    { emoji: '🧭', title: 'Smart Wanderer', desc: 'Balanced, sensible, quietly good at this. You read the city, avoided the traps, and kept both wallet and energy intact.', tip: 'You already move like a local. Come see how deep the stories go under the streets you handled so well.' }
  };
  ...
  var CSS = [
    ...
    '.bw-dsv-choice-l{font-size:16.5px;font-weight:800;color:var(--gd);}',
    '.bw-dsv-choice-m{font-size:13px;color:#4b5b4b;margin-top:2px;}',
    // outcome
    ...
    // buttons
    '.bw-dsv-btn{display:block;width:100%;background:var(--y);color:var(--gd);border:none;border-radius:14px;padding:16px;font-size:17px;font-weight:800;cursor:pointer;min-height:52px;transition:transform .05s,filter .15s;}',
