const BW_BLOG_HOME_DATA_URL = (() => {
  ...
  return new URL('./data.json?v=20260831-featured-listings', base).href;
})();

const BW_BLOG_HOME_FALLBACK = {
  featured: {
    title: 'Rent a Boat in Berlin: What You Can Drive, and Where You Can Take It',
    url: 'https://www.berlinwalk.com/post/rent-a-boat-in-berlin',
    category: 'Tourist Tips',
    readTime: '7 min read',
    label: "New: map Berlin's water access",
    summary: 'You can rent a 15 hp motorboat, a kayak or a SUP board in Berlin without any licence. What no booking page explains is the map: the stretch past the Reichstag and Museum Island is closed to all of them. Where the rules actually let you go, what it costs, and when the cruise is the honest answer.',
    image: 'https://static.wixstatic.com/media/5a08a3_9f32307a6a624a05b55fa6e746b47a76~mv2.jpg/v1/fill/w_980,h_650,fp_0.50_0.50,q_88,enc_avif,quality_auto/rent-a-boat-in-berlin-oberbaum-cruise.jpg',
    alt: 'A sightseeing boat passes under the red twin towers of the Oberbaumbruecke on the Spree'
  },
  miniPosts: [
    {
