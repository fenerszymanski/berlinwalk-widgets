...
const BW_BLOG_HOME_FALLBACK = {
  ...
  miniPosts: [
    ...
    },
    {
      ...
      category: 'Tourist Tips',
      readTime: '6 min read',
      summary: "3 October is Germany's national holiday, and in 2026 it falls on a Saturday, so Berlin runs Sunday rules two days in a row. What closes, the station supermarkets that stay open, the museums that keep Sunday hours, and how I would plan the weekend.",
      image: 'https://static.wixstatic.com/media/5a08a3_ff85376dc8e847509310f5fb022c30d0~mv2.jpg/v1/fill/w_980,h_650,fp_0.50_0.50,q_88,enc_avif,quality_auto/german-unity-day-berlin-reichstag-flag.jpg',
      alt: 'The German federal flag flying in front of the Reichstag building'
    },
    {
      title: 'Berlin Central Bus Station: Where Your FlixBus Arrives and How to Get Into the City',
      url: 'https://www.berlinwalk.com/post/berlin-central-bus-station',
      category: 'Tourist Tips',
      readTime: '5 min read',
      summary: "Berlin's central bus station sits 7 km west of Alexanderplatz, and almost nobody checks the stop list before booking. Which of the nine FlixBus stops to choose for your part of the city, the two stations that split Berlin between them, and the 4 EUR ticket that covers the ride in.",
      image: 'https://static.wixstatic.com/media/5a08a3_5d84175462c642fd83c46ed523d25cca~mv2.jpg/v1/fill/w_980,h_650,fp_0.50_0.50,q_88,enc_avif,quality_auto/berlin-central-bus-station-zob-boarding.jpg',
      alt: 'Travellers boarding a green FlixBus coach under the departure board at Berlin ZOB'
    },
    {
