 ...
 *
 * Build marker: berlin-rewind-landing-v2-year-only-rename-20260712
 */
(function () {
  'use strict';
  ...
  var BUILD = 'berlin-rewind-landing-v2-year-only-rename-20260712';
  var GAME_BUILD = 'berlin-rewind-v2-year-only-rename-20260712';
  ...
  var CSS = [
    ...
    '.bw-rwlp-hero:after{content:"";position:absolute;inset:auto 0 0;height:7%;background:linear-gradient(180deg,rgba(250,250,245,0),rgba(250,250,245,.72));z-index:-1;pointer-events:none}',
    '.bw-rwlp-hero-copy{position:relative;z-index:1;max-width:780px}.bw-rwlp-kicker{display:inline-flex;align-items:center;min-height:32px;background:var(--yellow);color:var(--green2);font-size:12px;font-weight:950;letter-spacing:1.6px;text-transform:uppercase;padding:8px 12px;margin:0 0 16px}',
    ...
    '.bw-rwlp-btn{display:inline-flex;align-items:center;justify-content:center;min-height:50px;border:2px solid transparent;border-radius:8px;padding:0 18px;font-size:15px;font-weight:950;text-decoration:none}.bw-rwlp-btn.primary{background:var(--yellow);color:var(--green2)}.bw-rwlp-btn.secondary{background:rgba(250,250,245,.08);border-color:rgba(255,230,0,.48);color:#fff}',
    '.bw-rwlp-chips{display:flex;flex-wrap:wrap;gap:10px}.bw-rwlp-chip{display:inline-flex;align-items:center;min-height:34px;border:1px solid rgba(255,255,255,.38);background:rgba(7,59,22,.42);border-radius:8px;color:#fff;font-size:12px;font-weight:900;letter-spacing:.8px;text-transform:uppercase;padding:8px 11px;box-shadow:0 12px 30px rgba(0,0,0,.16)}',
    ...
    '@media(min-width:901px){.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-card{height:760px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen.is-on{justify-content:flex-start;padding-block:0}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-eyebrow{font-size:11px;margin-bottom:5px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-title{font-size:30px;line-height:1.02;letter-spacing:0;margin-bottom:10px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-strip{max-width:560px;gap:8px;margin-bottom:12px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-strip-thumb{aspect-ratio:4/3}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-sub{font-size:14.5px;line-height:1.38;margin-bottom:11px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-chiprow{margin-bottom:9px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-chip{font-size:12.5px;padding:7px 11px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-table{width:100%;margin-bottom:9px;padding:3px 12px 6px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-table-h{font-size:10px;padding:8px 0 5px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-trow{padding:5px 0}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-global{width:100%;margin-bottom:9px;padding:8px 10px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-global-head{margin-bottom:6px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-me{margin-bottom:6px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-me span{padding:6px 7px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-lrow{min-height:20px;padding-top:3px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-tomorrow{margin:7px 0 0;font-size:13px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-btnrow{margin-top:7px;gap:8px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-btn{min-height:44px;padding:11px 14px;font-size:15px}.bw-rwlp-game-mount '+GAME_TAG+' .bw-rw-home-screen .bw-rw-foot{margin-top:7px;font-size:10.5px}}',
