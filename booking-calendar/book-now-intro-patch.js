(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      '@media(max-width:640px){bw-booking-calendar .bw-cal-intro h2{font-size:30px;line-height:1.05}bw-booking-calendar .bw-cal-intro p{font-size:14px}bw-booking-calendar .bw-cal-intro-chip{font-size:10.5px;min-height:28px;padding:6px 9px}}',
    ].join('');
