(function () {
  ...
  var RUNTIME_KEY = '__bwBookNowIntroPatchDepositMobileV320260920';
  if (window[RUNTIME_KEY]) return;
  window[RUNTIME_KEY] = true;
  window.__bwBookNowIntroPatchDepositMobileV220260920 = true;
  window.__bwBookNowIntroPatchDepositUiSafe20260920 = true;
  ...
  var INTRO_HTML = [
    ...
    '</div>',
    "<div class='bw-cal-booking-help' role='note'>",
    "<p>Already booked? Check your confirmation email to change or cancel your booking.</p>",
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      'html.bw-deposit-form-ui [data-hook="form-field-c75b1793-ac5f-4491-a1d6-61cc895c7b94"]>[data-hook="ricos-viewer"]{display:none!important}',
  ...
  function preserveAttribution(href) {
    ...
    // New reservations must not reuse a cached pre-deposit/mobile form shell.
    // Keep the selected session and attribution intact; never reload a filled form.
    if (url.pathname.toLowerCase().indexOf('/booking-form') === 0) {
      url.searchParams.set('booking_ui', 'deposit-v2-20260920');
    }
  ...
  function patchBookingHref() {
    ...
    if (!proto.__bwIntroHrefPatchDepositV2 && typeof proto._bookingHref === 'function') {
      ...
      proto.__bwIntroHrefPatchDepositV2 = true;
    }
