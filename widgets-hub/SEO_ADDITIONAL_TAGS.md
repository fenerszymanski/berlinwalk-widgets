...
2. **Structured Data** — One JSON-LD block (`CollectionPage` + `ItemList` listing all 19 widgets as `WebApplication` items). Paste as one entry.
...
<meta property="og:title" content="Free Berlin Widgets to Embed on Your Site | BerlinWalk" />
<meta property="og:description" content="19 free interactive Berlin widgets for travel sites, hotels, and bloggers: weather, transport, maps, calculators. Copy a one-line snippet, no signup, just attribution." />
...
<meta name="twitter:title" content="Free Berlin Widgets to Embed on Your Site | BerlinWalk" />
<meta name="twitter:description" content="19 free interactive Berlin widgets, copy a one-line snippet to embed on any travel site, hotel page, or blog." />
