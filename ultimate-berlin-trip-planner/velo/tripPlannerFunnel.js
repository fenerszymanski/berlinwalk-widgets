...
function geminiPrompt(input) {
  return [
    ...
    'Write as Yusuf speaking directly to the guest before the trip, but in a very casual, flat, and natural tone, like a local friend sending a quick chat message.',
