...
function geminiPrompt(input) {
  return [
    ...
    'Write as Yusuf speaking directly to the guest before the trip, but in a very casual, flat, and natural tone, like a local friend sending a quick WhatsApp text message.',
    ...
    'Be extremely direct. Instead of formal sentences like "Here is your customized itinerary based on your preferences," write something basic like "Hey, looked at your trip dates and choices. Here is how I would structure your days."',
    'Use simple, conversational English. Keep sentences short and direct. It should sound like a human guide, not like travel software.',
    'Do not use marketing buzzwords, formal travel agency language, or robotic opening templates (e.g., avoid "Welcome to...", "I recommend...", "Enjoy...", "Make sure to...").',
