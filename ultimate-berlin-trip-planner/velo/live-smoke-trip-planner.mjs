...
function buildLeadPayload(options) {
  ...
  return {
    ...
    carryPack: 'Save the exact plan link, route map, trip calendar, and World Clock prep note.',
    reservationRadar: 'Keep the World Clock context point, check timed museum entries, and keep arrival errands light.',
    ...
    dayOperations: 'Start, transit, timed-entry, and backup notes present for every day.',
    arrivalWindow: 'future_planning',
    tripRisk: 'low',
    tourRecommendation: 'Keep the World Clock context point early in the trip',
    intentStage: 'planning_ready',
    familyOrSlow: 'no',
    bookAheadNeeded: 'yes',
    conversionSignal: '75/100 - prep-ready planner lead; next action: save the context point',
    conversionScore: 75,
    conversionTier: 'warm_tour_lead',
    conversionNextAction: 'Save the World Clock context point before arrival',
    conversionReasons: 'arrival date known, context point early in trip, first-time route shape',
