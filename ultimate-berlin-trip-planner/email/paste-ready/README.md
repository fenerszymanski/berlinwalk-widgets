...
| --- | --- | --- | --- | --- |
| sales | instant | `TODO_TRIP_PLANNER_INSTANT` | [e0-instant-plan.html](e0-instant-plan.html) | 🗺️ Your Berlin plan from Yusuf |
| sales | minus7 | `TODO_TRIP_PLANNER_MINUS_7` | [e1-seven-days-before.html](e1-seven-days-before.html) | 🧳 One week until Berlin |
| sales | minus3 | `TODO_TRIP_PLANNER_MINUS_3` | [e2-three-days-before.html](e2-three-days-before.html) | ✅ Berlin in three days |
| sales | minus1 | `TODO_TRIP_PLANNER_MINUS_1` | [e3-one-day-before.html](e3-one-day-before.html) | 🌦️ Berlin tomorrow: ${weatherTitle} |
