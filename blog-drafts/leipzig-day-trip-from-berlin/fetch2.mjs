...
const FILES=[
 'Völkerschlachtdenkmal 2023.jpg',
 'Völkerschlachtdenkmal Leipzig 2022 01.jpg',
 'Battle of the Nations Monument in Leipzig; Recording in May 2024.jpg',
 'The Battle of the Nations Monument in Leipzig 04.jpg',
 'The Battle of the Nations Monument in Leipzig 01.jpg',
];
...
for(const f of FILES){
 ...
 meta.push(rec);
 const out='images/raw/vsd2_'+f.replace(/[^\w.\-]+/g,'_');
 ...
 console.log('OK '+f+' | '+rec.license+' | '+ii.width+'x'+ii.height+' | '+artist.slice(0,60));
}
