# Berlin Bike Lanes: What Tourists Must Know Before Walking or Riding
...
Berlin is not Copenhagen, but bikes are part of daily traffic here. The official [visitBerlin safe-cycling advice](https://www.visitberlin.de/en/15-tips-safe-cycling-berlin) tells riders to cycle on the right, watch car doors, avoid red lights, and never ride on the pavement. The legal baseline is in the German Road Traffic Regulations: [StVO section 2](https://www.gesetze-im-internet.de/stvo_2013/__2.html) says bicycle paths are mandatory only when signed with the right blue signs, but it also makes clear that bikes belong in traffic space, not randomly on sidewalks.
...
{{widget:berlin-bike-lane-reflex-checker}}
...
There are important child exceptions in [StVO section 2](https://www.gesetze-im-internet.de/stvo_2013/__2.html): children up to 8 must use the sidewalk, children up to 10 may use it, and an accompanying adult may use the sidewalk while accompanying a child up to 8. Even then, pedestrians must not be endangered or obstructed, and riders must dismount before crossing the road.
...
The federal [eKFV section 10](https://www.gesetze-im-internet.de/ekfv/__10.html) says electric micro-vehicles inside built-up areas must use cycle paths, shared or separated cycle-and-foot paths, cycle lanes, or bicycle streets when those exist. If they do not exist, riders use the road or traffic-calmed areas. Berlin.de's e-scooter guidance also says [electric scooters may not be ridden on sidewalks or pedestrian zones](https://www.berlin.de/en/getting-around/electric-scooter-sharing/6654721-5887714-bolt.en.html), and violations may lead to a fine.
...
You can take bicycles on parts of Berlin public transport, but it is not a magic escape button. Berlin.de explains that [bicycles can travel on regional trains, S-Bahn, U-Bahn and trams in marked carriages when space is available](https://www.berlin.de/en/public-transportation/6260186-2913840-bicycles-public-transport-costs-conditio.en.html). Wheelchairs and strollers have priority, and a bicycle ticket is required.
...
If your hotel is far from the center, compare cycling with normal public transport first. My [Berlin public transport guide](https://www.berlinwalk.com/post/berlin-public-transport-explained-for-tourists-u-bahn-s-bahn-tram-bus) is the better starting point for most first days, and the [alternative transport guide](https://www.berlinwalk.com/post/alternative-transport-berlin) helps when you are choosing between bikes, scooters, car share, taxi, and walking.
...
If you want that first orientation before renting anything, book the [BerlinWalk tip-based walking tour](https://www.berlinwalk.com/book-berlin-walking-tour/berlin-free-walking-tour-tip-based) first, then decide whether a bike or scooter actually fits your day.
