# Visual Sources - Pharmacy in Berlin

Draft slug: `pharmacy-in-berlin`

Visual quality gate date: 2026-06-22, Europe/Berlin.

No paid image-generation API/CLI was used. No AI-generated article visuals were used. Final set was selected from Wikimedia Commons photos of real Berlin pharmacies and checked in a local contact sheet:
...
5. `01-wilhelm-busch-apotheke-neukoelln.jpg`
   ...
   - Source: https://commons.wikimedia.org/wiki/File:Wilhelm-Busch-Apotheke_in_Berlin-Neuk%C3%B6lln.JPG
   - Direct file: https://upload.wikimedia.org/wikipedia/commons/3/3e/Wilhelm-Busch-Apotheke_in_Berlin-Neuk%C3%B6lln.JPG
   - Author: Saalebaer.
   - License: CC0 1.0 public domain dedication.
   - Rationale: real neighborhood pharmacy context; less glossy than the cover, but useful for showing ordinary Berlin street reality.
   - Alt text: `Wilhelm Busch Apotheke storefront on Karl-Marx-Strasse in Berlin Neukolln`

## Rejected / Backup Images

- `06-libertas-apotheke-neukoelln.jpg`
  - Source: https://commons.wikimedia.org/wiki/File:Libertas_Apotheke_in_Berlin.JPG
  - Author/license: Saalebaer, CC0 1.0.
  - Reason not used: acceptable documentation image, but the contact-sheet crop is flatter and less distinctive than the selected five.
