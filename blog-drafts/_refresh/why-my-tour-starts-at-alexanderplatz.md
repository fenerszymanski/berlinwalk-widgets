# Why My Tour Starts at Alexanderplatz (And Not at Brandenburg Gate)
...
[Berlin.de](https://www.berlin.de/en/attractions-and-sights/3560266-3104052-brandenburg-gate.en.html) calls it Berlin's most famous landmark and a symbol of division and unity. That is exactly right. The gate carries the story of Prussia, Napoleon, Nazi parades, the Cold War, the Wall, reunification and modern Germany.
...
[visitBerlin](https://www.visitberlin.de/en/alexanderplatz) describes Alexanderplatz as Berlin's eastern centre, an important transport junction, and an ideal starting point for sightseeing because so many attractions are within walking distance. That is the practical side.
...
If you want a dedicated map, the [BerlinWalk meeting point page](https://www.berlinwalk.com/meeting-point) has the exact location and tour-day details.
...
The [BerlinWalk route page](https://www.berlinwalk.com/berlin-walking-tour-route) shows the 12-stop story map from the World Clock at Alexanderplatz to Hackescher Markt. It is the same logic explained visually: start with orientation, move through layers, finish somewhere useful.
...
You can [book your free spot here](https://www.berlinwalk.com/book-berlin-walking-tour/berlin-free-walking-tour-tip-based).
