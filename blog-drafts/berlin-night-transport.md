# Berlin Night Transport: How to Get Around After Midnight

## Local Production Notes

- Focus keyword: Berlin night transport
- Search intent: tourist wants to know whether Berlin public transport runs at night, how late U-Bahn/S-Bahn run, whether night buses are safe/useful, and when to take a taxi.
- Category: Tourist Tips
- Secondary keywords: Berlin night bus, Berlin U-Bahn at night, Berlin public transport after midnight, Berlin S-Bahn night service, Berlin taxi at night
- Slug: berlin-night-transport
...
- Official/current sources checked on 2026-06-19:
  ...
  - Berlin.de tickets/fares/routes: https://www.berlin.de/en/public-transportation/1772016-2913840-tickets-fares-and-route-maps.en.html
  - BVG network maps/routes: https://www.bvg.de/en/connections/network-maps-and-routes
  - visitBerlin public transport: https://www.visitberlin.de/en/public-transport-berlin
  - BVG 24-hour ticket: https://www.bvg.de/en/subscriptions-and-tickets/all-tickets/24h-tickets/24h-ticket
  - S-Bahn Berlin visitors: https://sbahn.berlin/en/plan-a-journey/information-for-berlin-visitors/
...
According to [Berlin.de's official night transport page](https://www.berlin.de/en/public-transportation/1859225-2913840-night-buses-public-transport-at-night.en.html), U-Bahn and S-Bahn trains run all night on the nights from Friday to Saturday, from Saturday to Sunday, and before public holidays. At night, S-Bahn trains are listed at roughly 30-minute intervals and U-Bahn trains at roughly 15-minute intervals.
...
Berlin.de says U-Bahn and S-Bahn service usually stops around 1:00 to 1:30 AM on weeknights. The [BVG tourist FAQ](https://www.bvg.de/en/tourists/faq-tourists) gives the practical answer: the U-Bahn runs continuously at weekends, while during the week night buses marked with "N" take over the U-Bahn service.
...
[BVG's tourist FAQ](https://www.bvg.de/en/tourists/faq-tourists) says one ticket is valid for S-Bahn, U-Bahn, tram, bus and ferry. [Berlin.de's fare page](https://www.berlin.de/en/public-transportation/1772016-2913840-tickets-fares-and-route-maps.en.html) also explains that AB covers Berlin's urban area up to the city limits, while ABC includes the surrounding area, BER Airport and Potsdam.
...
For a quick ticket decision, use the [Berlin Transport Ticket Calculator](https://www.berlinwalk.com/tools/transport-ticket-calculator).
...
If you want to estimate whether the fare is reasonable, use the [Berlin Taxi or Uber Cost Checker](https://www.berlinwalk.com/tools/berlin-taxi-uber-cost-checker). For general taxi rules, I also have a full guide to [taxis and Uber in Berlin](https://www.berlinwalk.com/post/taxi-in-berlin).
...
For broader area context, read my [Berlin safety guide](https://www.berlinwalk.com/post/is-berlin-safe-to-visit-an-honest-2026-guide). If you are trying to decide whether a late shop, pharmacy, station shop or toilet finder solves a problem, the [Spati Survival Checker](https://www.berlinwalk.com/tools/spati-survival-checker) is also useful.

## Late arrivals: BER, Hauptbahnhof and ZOB

If you arrive late at BER Airport, remember the fare zone first: BER is in zone C, so you need ABC for public transport into central Berlin. The [S-Bahn Berlin visitor page](https://sbahn.berlin/en/plan-a-journey/information-for-berlin-visitors/) is a useful official starting point for arrival routes, and it also stresses the one-ticket structure across public transport.
...
For daytime or first-arrival planning, I have a separate [Berlin Hauptbahnhof guide](https://www.berlinwalk.com/post/berlin-hauptbahnhof-guide) and a [Berlin Station Arrival Planner](https://www.berlinwalk.com/tools/berlin-station-arrival-planner).
...
The [BVG network maps and route downloads](https://www.bvg.de/en/connections/network-maps-and-routes) are useful for understanding the system, but your final late route should always come from a live route planner.
...
If you are planning your first full day, start with the [Berlin First-Day Planner](https://www.berlinwalk.com/tools/berlin-first-day-planner) and keep this night guide for the evening.
