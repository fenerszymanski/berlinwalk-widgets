...
const SLUG = 'english-bookshops-in-berlin';
const TOOL_SLUG = 'berlin-reading-stop-line';
const DRAFT_DIR = 'blog-drafts/english-bookshops-in-berlin';
const BODY_PATH = path.join(ROOT, DRAFT_DIR, 'english-bookshops-in-berlin.body.md');
...
const ARTICLE_CREDITS_ID = 'article_image_credits_english_bookshops_in_berlin';
const TOURIST_TIPS_CATEGORY_ID = '6da64e22-3360-42ec-a558-e906e4deeb19';
const EMBED_VERSION = '20260819rsl1';
const POST = {
  title: 'English Bookshops in Berlin: Three Stops That Fit a Real Day',
  excerpt: 'Choose an English bookshop in Berlin by the day you actually have: Dussmann for range in Mitte, Shakespeare and Sons for a slower east-side pause, or Curious Fox for an independent Kreuzberg browse.',
  seoTitle: 'English Bookshops in Berlin: Three Useful Stops',
  description: 'A practical guide to English bookshops in Berlin: Dussmann in Mitte, Shakespeare and Sons in Friedrichshain and Curious Fox in Kreuzberg.',
  socialTitle: 'English Bookshops in Berlin: Three Stops That Fit a Real Day',
  socialDescription: 'Choose the shelf before the neighbourhood: a wide central browse, a book-and-café pause or an independent Kreuzberg stop.',
  hashtags: ['berlin', 'berlinwalk', 'berlinbookshops', 'englishbooks', 'berlintips'],
  keywords: ['English bookshops in Berlin', 'English bookstores Berlin', 'Dussmann English Bookshop', 'Shakespeare and Sons Berlin', 'Curious Fox Berlin'],
  tagLabels: ['Tourist Tips'],
  coverPath: 'images/optimized/01-dussmann-exterior.jpg',
};
const EMBEDS = {
  '{{quick-summary}}': { id: 'quick_summary_english_bookshops_in_berlin', url: `https://fenerszymanski.github.io/berlinwalk-widgets/quick-summary/?post=${SLUG}&v=${EMBED_VERSION}`, height: '1140' },
  [`{{widget:${TOOL_SLUG}}}`]: { id: `widget_${TOOL_SLUG.replace(/-/g, '_')}`, url: `https://fenerszymanski.github.io/berlinwalk-widgets/${TOOL_SLUG}/?v=${EMBED_VERSION}`, height: '2140' },
  '{{faq}}': { id: 'faq_english_bookshops_in_berlin', url: `https://fenerszymanski.github.io/berlinwalk-widgets/faq/?post=${SLUG}&v=${EMBED_VERSION}`, height: '1380' },
};
const CREDITS = [
  { label: 'Dussmann Kulturkaufhaus exterior', author: 'Gryffindor', licenseLabel: 'Public domain', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Dussmann_Kulturkaufhaus_4.JPG' },
  { label: 'Dussmann Kulturkaufhaus interior', author: 'Gryffindor', licenseLabel: 'Public domain', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Dussmann_Kulturkaufhaus_interior.JPG' },
  { label: 'Dussmann Kulturkaufhaus interior', author: 'Gryffindor', licenseLabel: 'Public domain', licenseUrl: 'https://creativecommons.org/publicdomain/mark/1.0/', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Dussmann_Kulturkaufhaus_interior2.JPG' },
  { label: 'Otherland, Kreuzberg', author: 'Saalebaer', licenseLabel: 'CC0', licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Otherland_Buchhandlung_in_Berlin-Kreuzberg.JPG' },
];
...
function seoData(cover) {
  ...
  const blogPosting = { '@context': 'https://schema.org', '@type': 'BlogPosting', headline: POST.title, description: POST.description, image: [cover.url], author: { '@type': 'Person', name: 'Yusuf Ucuz' }, publisher: { '@type': 'Organization', name: 'BerlinWalk', url: 'https://www.berlinwalk.com' }, mainEntityOfPage: canonical, inLanguage: 'en', articleSection: 'Tourist Tips', keywords: POST.keywords.join(', ') };
