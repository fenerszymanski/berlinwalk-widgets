...
Focus keyword: lost property Berlin
Slug: lost-property-berlin
...
If it was on a **BVG U-Bahn, tram or bus**, use the [BVG lost and found page](https://www.bvg.de/en/service-and-support/lost-and-found) and submit an online lost items report. BVG says you should describe the item as accurately as possible and that the request can stay active for several weeks.

If it was on a **Deutsche Bahn train or at a DB station**, use [DB's lost and found service](https://int.bahn.de/en/help/contact/lost-luggage). DB says online reports are for items worth more than **EUR 15**, and there can be a handling fee for collecting or sending an item.

If it was at **BER Airport**, use BER's official [Lost an item?](https://ber.berlin-airport.de/en/flying/baggage/gegenstand-verloren.html) page. BER separates terminal items from items left on a plane, in an apron bus, on airport trains and buses, or official documents.

If it was in the **street, a taxi, a shop, a park or somewhere vague**, use Berlin's [central lost property office guidance](https://www.berlin.de/en/tourism/travel-information/1735948-2862820-lost-and-found-and-lost-property-offices.en.html). Berlin.de lists the Central Lost Property Office at **Platz der Luftbrücke 6, 12101 Berlin**.
...
{{widget:berlin-lost-item-router}}
...
This is also why I prefer the [BVG or Jelbi app](https://www.berlinwalk.com/post/berlin-public-transport-explained-for-tourists-u-bahn-s-bahn-tram-bus) for normal Berlin transport planning: it keeps tickets and route details easier to reconstruct if you need to remember where you were.
...
If you are moving through Berlin with luggage, my [Berlin Hauptbahnhof guide](https://www.berlinwalk.com/post/berlin-hauptbahnhof-guide) and [luggage storage guide](https://www.berlinwalk.com/post/luggage-storage-in-berlin-2026) can help you avoid the other classic problem: dragging bags through too many transfers.
...
Before a departure day, read my [BER Airport departure guide](https://www.berlinwalk.com/post/berlin-ber-airport-departure-guide). It covers terminal timing, train tickets and security details, but the short rule here is simple: **do not wait until boarding time to solve a document problem.**
...
If the missing item is connected to a safety problem, read my [Berlin safety guide](https://www.berlinwalk.com/post/is-berlin-safe-to-visit-an-honest-2026-guide). Berlin is not a city where most visitors need to be scared, but pickpocketing and distraction theft do happen in crowded tourist zones and public transport.
